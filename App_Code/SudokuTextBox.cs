...
public class SudokuTextBox
{
    ...
    {
        textBox.ForeColor = System.Drawing.ColorTranslator.FromHtml("#c22c2c"); //set color to red, invalid
    }

    public void setCorrectNumber(){
        textBox.ForeColor = System.Drawing.ColorTranslator.FromHtml("#ecff00"); //set color to green, valid
        textBox.Enabled = false; //disable textbox because correct number
    }

    public void setHint()
    {
        textBox.ForeColor = System.Drawing.ColorTranslator.FromHtml("#7dfed0"); //show turquoise
    }

    public void setDefaultColor()
    {
        textBox.ForeColor = System.Drawing.ColorTranslator.FromHtml("#FFFFFF"); //default off white color
    }
